...
// Ruta de prueba para saber si el servidor está vivo en la web
app.get('/', (req, res) => {
    res.send('El servidor del asistente de código está encendido y corriendo perfectamente.');
});

// Ruta principal donde se procesan y escanean los códigos a reparar
app.post('/api/chat', async (req, res) => {
    ...
    try {
        // Instrucciones de sistema exactas para el escaneo de líneas y soporte técnico remoto
